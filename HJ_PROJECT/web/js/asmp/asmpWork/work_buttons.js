...
var toolbuttonsdata = $.ajax({
	   url: contextPath+"/soa/asmp/asmpWork/datas/getButtonsData",
	   async: false
	  }).responseText;
...
var buttonsAction = {
		'inst' : function(e, dt, node, conf){
			post("/soa/asmp/asmpWork/inst","html","",function(obj){
				//console.log(obj);
				var d = dialog({
					title : '报障',
					content :obj,					
	...
	'edit' : function(e, dt, node, conf){
		...
		if($chkbox_checked.length>1){
			...
			post("/soa/asmp/asmpWork/edit","html",data,function(obj){
				//console.log(obj);
				var d = dialog({
					title : '修改设备信息',
					content :obj,					
		...
		'del' : function(e, dt, node, conf) {
			...
			setTimeout(function() {
				...
				var d = dialog({
	                 ...
	                 ok:function(){
	                	 var that=this;
	                	 var url='/soa/asmp/asmpWork/datas/del';
	                	 delObject(id,url);
	                	setTimeout(function() {
