...
$(function(){
	...
	var lineurl="/soa/echarts/datas/device?cmd=line";
	var barurl="/soa/echarts/datas/device?cmd=bar";
	var pieurl="/soa/echarts/datas/device?cmd=pie";
	var tableurl="/soa/echarts/datas/device?cmd=table";
	...
	var charts={
	  ...
	  //在线状态饼图    
	    ...
	    function pie(datas){
			...
			$('#txt_zx').html(datas.onlineNumber);
	  ...
	  //导出
	    $('#deviceExport').on('click',function(){
	    	location.href =contextPath+'/soa/echarts/device/export?oid='+oid;
	    });
});
